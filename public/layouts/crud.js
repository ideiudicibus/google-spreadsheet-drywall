  ...
  app._SearchCollection = Backbone.Collection.extend({
    ...
    parse: function(response) {
      ...
      _.each(response.users, function(user) {
        outcome.push({name: user.username, url: '/crud/users/'+ user._id +'/'});
      });
      ...
      _.each(response.accounts, function(account) {
        outcome.push({name: account.name.full, url: '/crud/accounts/'+ account._id +'/'});
      });
      ...
      _.each(response.administrators, function(administrator) {
        outcome.push({name: administrator.name.full, url: '/crud/administrators/'+ administrator._id +'/'});
      });
