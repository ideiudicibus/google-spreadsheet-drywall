...
elem.toggleClass('active');
     ...
     $.ajax({        
        type: "POST",
        data: data,
        url: '/spreadsheets_v4/activesheet/g/'+spreadsheet.activeSheet,
        dataType:"json",
        success:  function (response) {
          ...
          switch(response.success)
          {
           ...
           templateLoader.loadRemoteTemplate(activeSheet._id, "/views/spreadsheets_v4/dashboard/"+activeSheet._id+"-tmpl.html?", 
            function(data) {
...
if($(this).attr('class').indexOf('checkPercentage')>0){
 ...
 $.ajax({
        ...
        data:params,
        type: "POST",
        url: '/spreadsheets_v4/'+data.record._id+'/'+data.record.activeSheet+'/params',
        dataType:"json",
        success:  function (response) {
...
console.log(params);
 ...
 $.ajax({
        ...
        data:params,
        type: "POST",
        url: '/spreadsheets_v4/'+data.record._id+'/'+data.record.activeSheet+'/reset',
        dataType:"json",
        success:  function (response) {
  ...
  event.preventDefault();
    ...
    if (e) {
      if (str.length==0 || str.length>50){alertify.error('la descrizione della simulazione è vuota oppure eccede i 50 caratteri previsti, riprovare'); return false; }
       ...
       data:postData,
        type: "POST",
        url: '/spreadsheets_v4/'+data.record._id+'/s/simulation',
        dataType:"json",
        success:  function (response) {
...
function resetParamsActiveSheetBtnBehaviour(){
  ...
  event.preventDefault();
    ...
    if (e) {
       ...
       data:data,
        type: "POST",
        url: '/spreadsheets_v4/activesheet/r/'+data.record.activeSheet,
        dataType:"json",
        success:  function (response) {
...
function loadSimulation(simId){
  ...
  $.ajax({
        data:data,
        type: "POST",
        url: '/spreadsheets_v4/'+data.record._id+'/l/simulation/'+simId,
        success:  function (response) {
...
$.ajax({
        ...
        url: '/spreadsheets_v4/'+data.record._id+'/g/simulations',
        success:  function (response) {
...
var activeSheetID=$(this).attr('id');
 ...
 $.ajax({
        data:data.record,
        type: "POST",
        url: '/spreadsheets_v4/activesheet/'+activeSheetID,
        dataType:"json",
